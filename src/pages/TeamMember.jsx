...
const TeamMember = () => {
  ...
  return (
    <PageLayout>
      {/* HERO */}
      <section className="relative min-h-[60vh] flex items-center bg-gradient-to-b from-slate-50 via-blue-50/50 to-white text-gray-900 pt-28 pb-16 px-6 overflow-hidden font-['Poppins']">
        <SectionBackdrop />
        ...
        <div className="max-w-7xl mx-auto relative z-10 w-full">
          <Link
            to="/about"
            className="inline-flex items-center gap-2 text-gray-500 hover:text-blue-600 transition-colors text-xs font-bold uppercase tracking-widest mb-10"
          >
            <ArrowLeft size={16} />
            Back to Team
          </Link>
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            ...
            >
              ...
              <div className="relative rounded-[2.5rem] overflow-hidden border border-gray-200 bg-white shadow-2xl">
                <img
                  src={member.image}
                  alt={member.name}
            ...
            <div className="lg:col-span-7 space-y-6">
              <Motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }}>
                ...
                <h1 className="text-4xl md:text-5xl font-black tracking-tighter leading-[1.02] mt-6">
                  {member.name}
                </h1>
                <p className="text-gray-600 text-lg md:text-xl mt-4 leading-relaxed font-medium max-w-2xl">
                  {member.shortBio}
                </p>
              </Motion.div>
              ...
              <Motion.div
                ...
                className="relative p-6 rounded-3xl bg-white border border-gray-200 shadow-lg shadow-blue-600/5"
              >
                <Quote size={22} className="text-blue-600 mb-3" />
                <p className="text-lg text-gray-800 font-medium italic leading-relaxed">"{member.quote}"</p>
              </Motion.div>
              ...
              >
                {[
                  ...
                  <span key={c.label} className="inline-flex items-center gap-2 px-4 py-2.5 rounded-full bg-white border border-gray-200 shadow-sm text-gray-700 text-xs font-bold">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-12 gap-12">
          <div className="lg:col-span-7 space-y-8">
            ...
            <Motion.div
              ...
              className="p-6 rounded-3xl bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-100"
            >
              <div className="flex items-center gap-3 mb-3">
                <Sparkles size={18} className="text-blue-600" />
                <h3 className="font-bold text-gray-900">Did You Know?</h3>
              </div>
              <p className="text-gray-700 leading-relaxed">{member.funFact}</p>
            </Motion.div>
          </div>
          ...
          <div className="lg:col-span-5 space-y-8">
            <Motion.div
              ...
              viewport={{ once: true }}
              className="bg-white border border-gray-200 rounded-[2rem] p-8 shadow-xl shadow-blue-600/5"
            >
              <h3 className="font-bold text-gray-900 mb-6 text-lg">Skills & Expertise</h3>
            ...
            >
              {member.stats.map((s, i) => (
                <div key={i} className="bg-white border border-gray-200 rounded-2xl p-5 text-center shadow-lg shadow-blue-600/5">
                  <p className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-cyan-500">{s.val}</p>
                  <p className="text-[9px] font-bold uppercase tracking-widest text-gray-500 mt-1">{s.lbl}</p>
                </div>
              ))}
            </Motion.div>
      ...
      {/* OTHER TEAM MEMBERS */}
      <section className="relative bg-gradient-to-b from-white via-blue-50/40 to-slate-50 py-16 px-6 border-t border-gray-100 font-['Poppins']">
        <SectionBackdrop />
        <div className="max-w-7xl mx-auto relative z-10">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-gray-900 mb-8 text-center">
            ...
            {teamMembers
              ...
              .map((m) => (
                <Link
                  key={m.id}
                  to={`/team/${m.id}`}
                  className="group relative rounded-2xl overflow-hidden border border-gray-200 bg-white hover:border-blue-400/50 hover:shadow-xl hover:shadow-blue-600/10 transition-all duration-300"
                >
                  ...
                  <div className="p-4">
                    <h4 className="font-bold text-sm text-gray-900 group-hover:text-blue-600 transition-colors">{m.name}</h4>
                    <p className="text-[9px] font-black uppercase tracking-widest text-gray-500 mt-1">{m.role}</p>
                  </div>
                </Link>
              ))}
          </div>
