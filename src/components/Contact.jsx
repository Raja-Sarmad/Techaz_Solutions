...
import { Mail, Phone, MapPin, Send, Zap, ShieldCheck, Clock3, AtSign, Globe, Share2, MessageCircle } from 'lucide-react';
...
const Contact = () => {
  return (
    <section id="contact" className="relative py-16 bg-gradient-to-b from-white via-blue-50/40 to-slate-50 overflow-hidden font-['Poppins'] text-gray-900 text-left">
      <SectionBackdrop />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
              ...
              {[
                ...
                >
                  <a
                    ...
                    rel="noreferrer"
                    className="group bg-white border border-gray-200 p-5 rounded-2xl flex items-center gap-5 shadow-lg shadow-blue-600/5 hover:border-blue-400/40 hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-600/10 transition-all duration-300"
                  >
            ...
            {/* Trust Indicator */}
            <motion.div {...fadeUp} className="p-6 rounded-3xl bg-white border border-gray-200 shadow-lg shadow-blue-600/5 flex items-center gap-5">
            ...
            <motion.div {...fadeUp} className="flex items-center gap-3">
              <span className="text-[10px] font-black uppercase tracking-widest text-gray-400 mr-2">Follow Us</span>
              {[
                { icon: <Share2 size={16} />, label: 'Facebook' },
                { icon: <AtSign size={16} />, label: 'Instagram' },
                { icon: <MessageCircle size={16} />, label: 'LinkedIn' },
              ...
              <form className="space-y-7 pt-4" onSubmit={(e) => e.preventDefault()}>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-gray-200 rounded-2xl px-6 py-4 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 focus:bg-white transition-all"
                    />
                  </div>
                  <div className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-3">
                    ...
                    <select className="w-full bg-slate-50 border border-gray-200 rounded-2xl px-6 py-4 text-gray-900 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all appearance-none cursor-pointer">
                      <option className="bg-white">$1k – $5k</option>
                      <option className="bg-white">$5k – $15k</option>
                      <option className="bg-white">$15k – $50k</option>
                      <option className="bg-white">$50k+</option>
                      <option className="bg-white">Not sure yet</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <select className="w-full bg-slate-50 border border-gray-200 rounded-2xl px-6 py-4 text-gray-900 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition-all appearance-none cursor-pointer">
                      ...
                      <option className="bg-white">AI & Automation</option>
                ...
                <div className="space-y-3">
                  ...
                  <textarea
                    ...
                    className="w-full bg-slate-50 border border-gray-200 rounded-2xl px-6 py-4 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 focus:bg-white transition-all resize-none"
                  ></textarea>
                </div>
