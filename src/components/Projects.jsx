...
const Projects = () => {
  ...
  return (
    <section className="relative min-h-screen bg-[#121212] text-white py-24 md:py-32 px-6 overflow-hidden selection:bg-blue-500/30" id="projects">
      {/* Background elements */}
      <canvas ref={canvasRef} className="absolute inset-0 pointer-events-none opacity-50" />
      
      {/* Glow Blobs */}
      <div className="absolute -top-[10%] -right-[5%] w-[600px] h-[600px] rounded-full bg-blue-600/10 blur-[120px] pointer-events-none" />
